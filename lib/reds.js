...
exports.metaphone = natural.Metaphone.process;
exports.metaphoneOn = natural.Metaphone.process;
exports.metaphoneOff = function(word) {return word;};
...
exports.metaphoneMap = function(words){
  var obj = {};
  for (var i = 0, len = words.length; i < len; ++i) {
    obj[words[i]] = exports.metaphone(words[i]);
  }
  return obj;
};
...
exports.metaphoneArray = function(words){
  var arr = []
    , constant;
  for (var i = 0, len = words.length; i < len; ++i) {
    constant = exports.metaphone(words[i]);
